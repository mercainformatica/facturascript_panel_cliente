 ...
 */
class paneldeclientes extends fs_controller
{
   public $texto;
   public $texto2;
   public $lista;
   ...
   {
      parent::__construct(__CLASS__, 'Mis Servicios', 'Panel Cliente');
   }
   ...
   protected function private_core()
   {
      ...
      $this->resultados_sql = $this->db->select("select * from servicioscli;");
   }
}
